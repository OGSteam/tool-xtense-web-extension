...
function initParsers() {
    ...
    XtenseXpaths = {
        ...
        galaxy: {
            ...
            activity: 'div[contains(@class,"microplanet")]/div[contains(@class,"ListImage")]/div[contains(@class,"activity")]/text()',
            activity15: 'div[contains(@class,"microplanet")]/div[contains(@class,"ListImage")]/div[contains(@class,"minute15")]/@class',
            activity_m: 'div[contains(@class,"moon")]/div[contains(@class,"activity")]/text()',
            activity15_m: 'div[contains(@class,"moon")]/div[contains(@class,"minute15")]/@class',
            player_id: 'div[contains(@class,"playername")]/a[contains(@rel,"player")]/@rel',
            ally_id: 'div[contains(@class,"allytag")]/span[contains(@rel,"alliance")]/@rel',
            planet_id: 'div[contains(@class,"microplanet")]/@data-planet-id',
            moon_id: 'div[contains(@class,"moon")]/@data-moon-id',
