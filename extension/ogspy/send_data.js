...
function initOGSpyCommunication() {
  ...
  XtenseDatabase = {
    ...
    "buildings": { 1: "M", 2: "C", 3: "D", 4: "CES", 12: "CEF", 14: "UdR", 15: "UdN", 21: "CSp", 212: "Sat", 22: "HM", 23: "HC", 24: "HD", 25: "CM", 26: "CC", 27: "CD", 31: "Lab", 33: "Ter", 34: "DdR", 44: "Silo", 41: "BaLu", 42: "Pha", 43: "PoSa" },
    "researchs": { 106: "Esp", 108: "Ordi", 109: "Armes", 110: "Bouclier", 111: "Protection", 113: "NRJ", 114: "Hyp", 115: "RC", 117: "RI", 118: "PH", 120: "Laser", 121: "Ions", 122: "Plasma", 123: "RRI", 124: "Astrophysique", 199: "Graviton" },
    "fleet": { 202: "PT", 203: "GT", 204: "CLE", 205: "CLO", 206: "CR", 207: "VB", 208: "VC", 209: "REC", 210: "SE", 211: "BMD", 212: "SAT", 213: "DST", 214: "EDLM", 215: "TRA" },
            ...
            try {
                ...
                if (storageGetValue("backup.link", "false").toString() === "true") {
                    try {
                        ...
                        const backupSendObject = new Xajax({
    ...
    if (Response.match(/^\{.*\}$/g)) {
      try {
        ...
        if (data.status === 0) {
          ...
          switch (code) {
            case "home updated":
              const pageType = data.page || "unknown";
